...
class TestEval(unittest.TestCase):
    ...
    def test_cmp(self):
        self._test_tuples(
            ...
            ('"a" < "b"', 'true'),
            ('"b" >= "a"', 'true'),
            ("1 < true", "(Ln 1, Col 1) Cannot compare Int and Boolean", WDL.Error.IncompatibleOperand),
            ('"a" > 1', "(Ln 1, Col 1) Cannot compare String and Int", WDL.Error.IncompatibleOperand),
            ("3<2 || 1>=0","true"),
            ("3<2&&1>=0","false"),
            ("3<2&&1>=0||1==1","true"),
